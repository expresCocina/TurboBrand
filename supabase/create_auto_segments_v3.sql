-- Este es el script AUTOMÁTICO (Versión Corregida V3)
-- Usa el nombre de tabla CORRECTO: contact_segments
...
BEGIN
    ...
    FOR i IN 1..num_segments LOOP
        -- Crear el segmento en la base de datos (Usando contact_segments)
