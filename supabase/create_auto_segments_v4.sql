-- Este es el script COMPLETO (Versión V4)
-- 1. ELIMINA los segmentos automáticos anteriores
-- 2. CREA los nuevos segmentos (80 contactos c/u)
-- 3. Usa la tabla correcta: contact_segments
...
BEGIN
    ...
    -- Nota: Al eliminar el segmento, los miembros se eliminan automáticamente (ON DELETE CASCADE)
